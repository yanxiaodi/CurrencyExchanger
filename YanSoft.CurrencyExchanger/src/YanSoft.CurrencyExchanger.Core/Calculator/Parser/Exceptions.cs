...
namespace YanSoft.CurrencyExchanger.Core.Calculator.Parser
{
    ...
    {
        public FunctionParserException(string msg)
            : base(msg)
        { }
        public FunctionParserException(string msg, Exception innerException)
    ...
    public class InvalidExpressionException : FunctionParserException
    {
        public InvalidExpressionException(string msg)
            : base(msg)
        { }
        public InvalidExpressionException(string msg, Exception innerException)
            : base(msg, innerException)
        { }
    }
    ...
    {
        public TrailingTokensException(string msg)
            : base(msg)
        { }
    }
    ...
    {
        public CannotDifferentiateException(string msg)
            : base(msg)
        { }
    }
}

...
using YanSoft.CurrencyExchanger.Core.Calculator.HelperModules;
...
namespace YanSoft.CurrencyExchanger.Core.Calculator.Parser
{
    ...
    class FunctionParser
    {
        ...
        public static IExpression Parse(Function function)
        {
            return Parse(function.yExpression);
        }
        ...
        private static IExpression ParseFactor()
        {
            ...
            do
            {
                ...
                switch (CurrentToken.type)
                {
                    ...
                    case TokenType.SineHyper:
                    case TokenType.CosineHyper:
                    case TokenType.TangentHyper:
                    case TokenType.Log:
        ...
        private static IExpression ParseFunction()
        {
            ...
            switch (opType)
            {
                ...
                case TokenType.SineHyper:
                    return new HyperbolicSineExpression(exp);

                case TokenType.CosineHyper:
                    return new HyperbolicCosineExpression(exp);

                case TokenType.TangentHyper:
                    return new HyperbolicTangentExpression(exp);
